...
var PrimeReactProvider = function PrimeReactProvider2(props) {
  ...
  var _useState9 = (0, import_react.useState)((_propsValue$styleCont = propsValue.styleContainer) !== null && _propsValue$styleCont !== void 0 ? _propsValue$styleCont : null), _useState0 = _slicedToArray2(_useState9, 2), styleContainer = _useState0[0], setStyleContainer = _useState0[1];
  var _useState1 = (0, import_react.useState)((_propsValue$cssTransi = propsValue.cssTransition) !== null && _propsValue$cssTransi !== void 0 ? _propsValue$cssTransi : true), _useState10 = _slicedToArray2(_useState1, 2), cssTransition = _useState10[0], setCssTransition = _useState10[1];
  var _useState11 = (0, import_react.useState)((_propsValue$autoZInde = propsValue.autoZIndex) !== null && _propsValue$autoZInde !== void 0 ? _propsValue$autoZInde : true), _useState12 = _slicedToArray2(_useState11, 2), autoZIndex = _useState12[0], setAutoZIndex = _useState12[1];
  var _useState13 = (0, import_react.useState)((_propsValue$hideOverl = propsValue.hideOverlaysOnDocumentScrolling) !== null && _propsValue$hideOverl !== void 0 ? _propsValue$hideOverl : false), _useState14 = _slicedToArray2(_useState13, 2), hideOverlaysOnDocumentScrolling = _useState14[0], setHideOverlaysOnDocumentScrolling = _useState14[1];
  var _useState15 = (0, import_react.useState)((_propsValue$nonce = propsValue.nonce) !== null && _propsValue$nonce !== void 0 ? _propsValue$nonce : null), _useState16 = _slicedToArray2(_useState15, 2), nonce = _useState16[0], setNonce = _useState16[1];
  var _useState17 = (0, import_react.useState)((_propsValue$nullSortO = propsValue.nullSortOrder) !== null && _propsValue$nullSortO !== void 0 ? _propsValue$nullSortO : 1), _useState18 = _slicedToArray2(_useState17, 2), nullSortOrder = _useState18[0], setNullSortOrder = _useState18[1];
  var _useState19 = (0, import_react.useState)((_propsValue$zIndex = propsValue.zIndex) !== null && _propsValue$zIndex !== void 0 ? _propsValue$zIndex : {
    modal: 1100,
    overlay: 1e3,
    menu: 1e3,
    tooltip: 1100,
    toast: 1200
  }), _useState20 = _slicedToArray2(_useState19, 2), zIndex = _useState20[0], setZIndex = _useState20[1];
  var _useState21 = (0, import_react.useState)((_propsValue$ptOptions = propsValue.ptOptions) !== null && _propsValue$ptOptions !== void 0 ? _propsValue$ptOptions : {
    mergeSections: true,
    mergeProps: true
  }), _useState22 = _slicedToArray2(_useState21, 2), ptOptions = _useState22[0], setPtOptions = _useState22[1];
  var _useState23 = (0, import_react.useState)((_propsValue$pt = propsValue.pt) !== null && _propsValue$pt !== void 0 ? _propsValue$pt : void 0), _useState24 = _slicedToArray2(_useState23, 2), pt = _useState24[0], setPt = _useState24[1];
  var _useState25 = (0, import_react.useState)((_propsValue$unstyled = propsValue.unstyled) !== null && _propsValue$unstyled !== void 0 ? _propsValue$unstyled : false), _useState26 = _slicedToArray2(_useState25, 2), unstyled = _useState26[0], setUnstyled = _useState26[1];
  var _useState27 = (0, import_react.useState)((_propsValue$filterMat = propsValue.filterMatchModeOptions) !== null && _propsValue$filterMat !== void 0 ? _propsValue$filterMat : {
    text: [FilterMatchMode.STARTS_WITH, FilterMatchMode.CONTAINS, FilterMatchMode.NOT_CONTAINS, FilterMatchMode.ENDS_WITH, FilterMatchMode.EQUALS, FilterMatchMode.NOT_EQUALS],
    numeric: [FilterMatchMode.EQUALS, FilterMatchMode.NOT_EQUALS, FilterMatchMode.LESS_THAN, FilterMatchMode.LESS_THAN_OR_EQUAL_TO, FilterMatchMode.GREATER_THAN, FilterMatchMode.GREATER_THAN_OR_EQUAL_TO],
    date: [FilterMatchMode.DATE_IS, FilterMatchMode.DATE_IS_NOT, FilterMatchMode.DATE_BEFORE, FilterMatchMode.DATE_AFTER]
  }), _useState28 = _slicedToArray2(_useState27, 2), filterMatchModeOptions = _useState28[0], setFilterMatchModeOptions = _useState28[1];
...
//# sourceMappingURL=chunk-BJBY3N6C.js.map
