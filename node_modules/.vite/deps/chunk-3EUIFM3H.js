...
var VirtualScroller = React4.memo(React4.forwardRef(function(inProps, ref) {
  ...
  var _React$useState9 = React4.useState(props.numToleratedItems), _React$useState0 = _slicedToArray(_React$useState9, 2), numToleratedItemsState = _React$useState0[0], setNumToleratedItemsState = _React$useState0[1];
  var _React$useState1 = React4.useState(props.loading || false), _React$useState10 = _slicedToArray(_React$useState1, 2), loadingState = _React$useState10[0], setLoadingState = _React$useState10[1];
  var _React$useState11 = React4.useState([]), _React$useState12 = _slicedToArray(_React$useState11, 2), loaderArrState = _React$useState12[0], setLoaderArrState = _React$useState12[1];
...
//# sourceMappingURL=chunk-3EUIFM3H.js.map
